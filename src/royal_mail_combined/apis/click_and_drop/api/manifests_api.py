...
from ..models import ManifestOrdersResponse
from ..models.manifest_details_response import ManifestDetailsResponse
...
class ManifestsApi:
    ...
    def get_manifest_async(
            self,
            manifest_identifier: Annotated[StrictInt, Field(
