...
from royal_mail_combined.apis.returns.models import ReturnsRequest
...
class OrdersApi:
    ...
    def create_orders_async(
            self,
            create_orders_request: create_orders_request.CreateOrdersRequest,
    ...
    def delete_orders_async(
            self,
            order_identifiers: Annotated[StrictStr, Field(
    ...
    def get_orders_async(
            self,
            page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(
                description='The number of items to return'
            )] = None,
            start_date_time: Annotated[
                Optional[datetime], Field(description='Date and time lower bound for items filtering')] = None,
            end_date_time: Annotated[
                Optional[datetime], Field(description='Date and time upper bound for items filtering')] = None,
            continuation_token: Annotated[
                Optional[StrictStr], Field(description='The token for retrieving the next page of items')] = None,
            _request_timeout: Union[
                None,
                Annotated[StrictFloat, Field(gt=0)],
                Tuple[
    ...
    def update_orders_status_async(
            self,
            update_orders_status_request: Annotated[UpdateOrdersStatusRequest, Field(
